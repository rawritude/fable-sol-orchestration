...
| `skills/codex-first/PRE-DONE.md` | `~/.claude/skills/codex-first/` | Pre-done checklist appended to every implementation-lot prompt — 8 author-side checks distilled from real ship-gate catches; lot reports end with per-item PASS/N-A |
